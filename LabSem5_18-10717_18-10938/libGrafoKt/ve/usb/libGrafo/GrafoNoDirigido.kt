...
public class GrafoNoDirigido: Grafo {
    ...
    fun ladosAdyacentes(l: Arista) : Iterable<Arista> {
         ...
         *  Tiempo: O(|V| + |E|)
         */
        if (0 > l.v || l.v >= listaDeVertices.size) throw RuntimeException("no se encuentra el vertice en el grafo")
        if (0 > l.u || l.u >= listaDeVertices.size) throw RuntimeException("no se encuentra el vertice en el grafo")
